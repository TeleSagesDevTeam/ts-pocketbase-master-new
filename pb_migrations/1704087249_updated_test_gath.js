...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("wkbgxibh")

  // remove
  collection.schema.removeField("rndn2xn8")

  // remove
  collection.schema.removeField("cam5bcmb")

  // remove
  collection.schema.removeField("fhvnkxjb")

  // remove
  collection.schema.removeField("fyeufyv7")

  // remove
  collection.schema.removeField("wkhb0pir")

  // remove
  collection.schema.removeField("2vacnyur")

  // remove
  collection.schema.removeField("untshv3b")

  // remove
  collection.schema.removeField("nkmpljkp")

  // remove
  collection.schema.removeField("cmzo0nqs")

  // remove
  collection.schema.removeField("4zrvngyc")

  // remove
  collection.schema.removeField("xqdkx57z")

  // remove
  collection.schema.removeField("hqsdt9wm")

  // remove
  collection.schema.removeField("tgrsrint")

  // remove
  collection.schema.removeField("dcsa95tu")

  // remove
  collection.schema.removeField("5u5kd4bk")

  // remove
  collection.schema.removeField("qs1hnm9b")
