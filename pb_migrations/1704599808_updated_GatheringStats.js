...
migrate((db) => {
  ...
  collection.name = "oldGatheringStats"
  ...
  // remove
  collection.schema.removeField("mt4rcfra")

  // remove
  collection.schema.removeField("bqliz1og")

  // remove
  collection.schema.removeField("bsda8mpu")

  // remove
  collection.schema.removeField("jtghqech")

  // remove
  collection.schema.removeField("vpclx5ud")

  // remove
  collection.schema.removeField("pqx8ly2e")
